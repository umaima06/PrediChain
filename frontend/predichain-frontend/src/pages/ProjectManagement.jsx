...
const dummyProjects = [
  { id: 'd1', name: 'Metro Station A', location: 'Delhi', type: 'Building', startDate: '2025-01-01', endDate: '2025-12-31', status: 'Active', owner: 'system' },
  { id: 'd2', name: 'Bridge Expansion Project', location: 'Mumbai', type: 'Bridge', startDate: '2025-03-01', endDate: '2026-01-01', status: 'Upcoming', owner: 'system' },
  // add as many dummy ones as you like
];
...
const ProjectManagement = () => {
  ...
  const unsubscribe = onAuthStateChanged(auth, async (user) => {
    ...
    try {
      ...
      setProjects([...dummyProjects, ...userProjects]);
    } catch (err) {
      console.error("Error fetching projects:", err);
      alert("Firestore access denied — check your permissions or login again.");
    }
  });
